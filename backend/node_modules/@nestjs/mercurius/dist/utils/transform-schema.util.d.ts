...
export declare function typeIncludesDirective(type: any, directiveName: any): boolean;
/**
 ...
 * @param schema
 */
export declare function transformFederatedSchema(schema: GraphQLSchema): GraphQLSchema;
