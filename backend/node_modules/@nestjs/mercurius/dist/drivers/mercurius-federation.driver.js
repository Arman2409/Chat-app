...
let MercuriusFederationDriver = class MercuriusFederationDriver extends graphql_1.AbstractGraphQLDriver {
    ...
    async start(options) {
        const { plugins, hooks, ...adapterOptions } = await this.graphqlFederationFactory.mergeWithSchema(options, build_mercurius_federated_schema_util_1.buildMercuriusFederatedSchema);
        ...
        await (0, register_mercurius_hooks_util_1.registerMercuriusHooks)(app, hooks);
    }
